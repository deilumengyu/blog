...
import com.example.black_myblog.dto.ChatRecordDTO;
import com.example.black_myblog.dto.RecallMessageDTO;
import com.example.black_myblog.dto.WebsocketMessageDTO;
import com.example.black_myblog.entity.ChatRecord;
import com.example.black_myblog.mapper.ChatRecordMapper;
...
import static com.example.black_myblog.enums.ChatTypeEnum.*;
    ...
    public static class ChatConfigurator extends ServerEndpointConfig.Configurator {
        ...
        public void modifyHandshake(ServerEndpointConfig sec, HandshakeRequest request, HandshakeResponse response) {
            try {
                ...
                request.getHeaders().get(HEADER_NAME.toLowerCase()).forEach( System.out::println);
