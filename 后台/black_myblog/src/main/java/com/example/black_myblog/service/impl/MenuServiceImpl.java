...
import com.example.black_myblog.entity.RoleMenu;
import com.example.black_myblog.exception.BizException;
import com.example.black_myblog.mapper.MenuMapper;
import com.example.black_myblog.mapper.RoleMenuMapper;
import com.example.black_myblog.service.MenuService;
...
import static com.example.black_myblog.constant.CommonConst.COMPONENT;
...
public class MenuServiceImpl extends ServiceImpl<MenuMapper, Menu> implements MenuService {
    ...
    @Override
    public List<UserMenuDTO> listUserMenus() { // 查询用户菜单信息
